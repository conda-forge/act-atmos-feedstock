About act-atmos-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/act-atmos-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7842&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/act-atmos-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `act-atmos` can be installed with `conda`:
...
```
mamba install act-atmos
```

It is possible to list all of the versions of `act-atmos` available on your platform with `conda`:
...
```
mamba search act-atmos --channel conda-forge
```
...
mamba repoquery search act-atmos --channel conda-forge

# List packages depending on `act-atmos`:
mamba repoquery whoneeds act-atmos --channel conda-forge

# List dependencies of `act-atmos`:
mamba repoquery depends act-atmos --channel conda-forge
```
